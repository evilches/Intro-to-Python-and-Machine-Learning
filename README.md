...
To run a code cell use `Shift-Enter` or press the **<img src="Graphics/run_cell.png" width="55" title="Run" alt="Run"/>** button in the toolbar at the top part of the page.
